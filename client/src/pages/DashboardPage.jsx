...
const DashboardPage = () => {
  ...
  if (loading) return <p className="text-center mt-10 text-blue-600">Loading dashboard...</p>;

  return (
    <div className="max-w-5xl mx-auto mt-10 px-4">
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-3xl font-bold text-gray-800">📊 VentureLens Dashboard</h1>
        <button
