...
import { Menu, X, Home, LayoutDashboard, LogOut, User, ActivitySquare } from "lucide-react";
        ...
        <div className="hidden md:flex gap-2 items-center">
          ...
          {user && (
            <>
              ...
              <Link
                to="/analyze"
                className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-blue-600 to-blue-500 text-white font-medium rounded-lg hover:from-blue-500 hover:to-blue-400 shadow-md hover:shadow-lg transform hover:-translate-y-0.5 transition-all duration-200"
              >
          ...
          {user && (
            <>
              ...
              <Link
                to="/analyze"
                onClick={() => setOpen(false)}
                className="flex items-center gap-3 px-4 py-3 bg-gradient-to-r from-blue-600 to-blue-500 text-white font-medium rounded-lg hover:from-blue-500 hover:to-blue-400 shadow-md transition-all duration-200"
              >
